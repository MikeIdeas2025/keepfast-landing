        ...
        <div className="flex items-center gap-3">
          ...
          <div className="hidden md:flex items-center gap-2 mr-4">
            <a
              ...
              className="w-9 h-9 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center text-gray-700 hover:text-black transition-all duration-200"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-9 h-9 rounded-full bg-gray-100 hover:bg-blue-100 flex items-center justify-center text-gray-700 hover:text-blue-700 transition-all duration-200"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-9 h-9 rounded-full bg-gray-100 hover:bg-gray-800 flex items-center justify-center text-gray-700 hover:text-white transition-all duration-200"
